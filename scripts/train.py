...
python scripts/train.py --dataset SketchycocoLFDataset --dataset_root_path ~/datasets/SketchyCOCO-lf --logger_comment SketchyCOCOlf --output_dim 80 --resume ./runs/SketchyCOCO/version_1/checkpoints/best-SketchyCOCO.ckpt --pre_model False
'''